...
import ThriftSourceProtocol
from ttypes import ThriftFlumeEvent
...
if __name__ == '__main__':
    ...
    flume_client = FlumeClient('127.0.0.1', 399882)
    event = ThriftFlumeEvent({'headers': '{}'}, 'events under hello world2')
    events = [ThriftFlumeEvent({'a': 'hello', 'b': 'world'}, 'events under hello world%s' % random.randint(0, 1000)) for
              _ in range(100)]
